...
FILES="RNN CNN Transformer LMT Fractal ArchCompare Efficiency InfoDynamics Murray Training CriticalPoint"
...
echo "TOTAL: $TOTAL 条"
[ "$TOTAL" -ge 73 ] && echo "RESULT: ALL-PASS" && exit 0 || { echo "RESULT: 定理数异常"; exit 1; }
